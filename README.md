...
| Repo | What it is |
|------|------------|
| **[SPECTRA](https://github.com/JAKSecurity/SPECTRA)** | Automated monthly cybersecurity policy digest.  Collects from 17 RSS/API sources, curates with Claude, renders to PDF.  2,100 lines, 60 tests, MIT licensed. |
